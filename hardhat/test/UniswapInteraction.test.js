...
describe("UniswapInteraction", function () {
  ...
  beforeEach(async function () {
    ...
    await tokenA.approve(uniswapInteraction.address, ethers.utils.parseEther("100"));
    await tokenB.approve(uniswapInteraction.address, ethers.utils.parseEther("100"));
  });
